...
class DigitalAnalogConverterX2XLadder():
    ...
    def input_value_to_analog_energy(self, input_value: int) -> float:
        ...
        #print(input_value, input_value_bits)
...
if __name__ == "__main__":
    ...
    avg = 0
    for i in range(30):
        print(f"{i}: {dac.convert_value(i, latency=1e-9)}")

        avg += dac.convert_value(i, latency=1e-9) * 1e6

    print(f"Avg: {avg / 2 ** 8}", "Controller: ", dac.get_controller_energy())
